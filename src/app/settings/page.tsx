...
import { Smartphone, Globe, Info, ExternalLink } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <div className="card">
            ...
            <div className="flex items-center gap-3">
              {isStandalone ? (
                <>
                  <Smartphone className="text-[var(--color-secondary)]" size={24} />
                  <div>
          ...
          {!isStandalone && (
            <div className="card bg-[var(--color-primary)]/10 border-[var(--color-primary)]/20">
              <div className="flex items-start gap-3">
                <Info className="text-[var(--color-primary)] flex-shrink-0 mt-0.5" size={20} />
                <div>
